...
public class Day14 {
    ...
    public static List<String> getPuzzleInput() {
        return AdventureHelper.getFileByLines("Day14/Input");
    }

    public static List<String> getPuzzleTestInput() {
        return AdventureHelper.getFileByLines("Day14/TestInput");
    }

    public static List<String> getPuzzleTestInput2() {
        return AdventureHelper.getFileByLines("Day14/TestInput2");
    }
